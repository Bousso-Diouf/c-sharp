    ...
    public class GMailer
    {
        ...
        public static void senMail(string destinataire, string subjet, string body)
        {
            try
            {
                ...
                GMailer.GmailUsername = "elcheikh771@gmail.com"; //System.Configuration.ConfigurationManager.AppSettings["Email"];
                GMailer.GmailPassword = "pccm gynu etiy xxfd"; //System.Configuration.ConfigurationManager.AppSettings["PasswordEmail"];
